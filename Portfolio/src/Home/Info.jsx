...
function Info() {
  ...
  return (
    <div>
        <div className=" mt-5 mx-3  info rounded-5 px-3 py-3 bg-dark text-dark-light">
          <div className=" row  d-sm-none justify-content-center align-items-center ">
          ...
          <div className="Large-Screen d-sm-block d-none">
